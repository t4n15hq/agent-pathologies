...
collected per (family, role), and exclusion counts by reason.
...
\toprule
Family & Role & Upstream & $N_{\mathrm{cells}}$ & $N_{\mathrm{analyzable}}$ & pre-recovery excl & effective excl \\
\midrule
V4-flash  & instruct  & DeepSeek-direct      & $1000{+}600{+}1200$ & $1000{+}600{+}1200$ & $0$ & $0+0+0$ \\
V4-flash  & reasoning & DeepSeek-direct      & $1000{+}600{+}1200$ & $1000{+}600{+}1200$ & $\approx668$ & $0+0+0$ \\
V4-pro    & instruct  & mixed$^\dagger$      & $1000{+}600{+}1200$ & $1000{+}600{+}1200$ & $0$ & $0+0+0$ \\
V4-pro    & reasoning & mixed$^\dagger$      & $1000{+}600{+}1200$ & $1000{+}600{+}1200$ & $\approx407$ & $0+0+0$ \\
...
sycophancy, context-rot). Pre-recovery exclusions are stage-1 totals
before the 2026-05-15 max\_tokens amendment; exact per-axis splits are
not preserved in this summary table. See \S\ref{sec:methods:v4pro-routing}
and \S\ref{sec:limitations} for the routing recovery that cleared them.
After the 2026-05-15 amendment recoveries
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.90\linewidth]{figures/fig1_headline_forest.pdf}
