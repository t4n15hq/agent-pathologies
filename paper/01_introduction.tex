...
same task seeds. The four model pairs are drawn from the open-weight
families that ship explicit instruct/reasoning siblings sharing the
same base weights or matched at the same scale: DeepSeek V4-pro toggled
